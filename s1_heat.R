...
mat$total_signal <- NULL
# total <- mat
# total$mat_signal <- NULL

mat <- as.data.frame(pivot_wider(mat, names_from = "sample", values_from = "max_signal"))
...
png("./heat_max.png", width = 7, height = 15, unit = "in", res = 500)
draw(
